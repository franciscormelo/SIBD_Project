...
INSERT INTO indicator VALUES ('Vitamin D',75,'ng/mL','Values between 20-100 ng/m are also acceptable',1);
INSERT INTO indicator VALUES ('Neutrophils',50,'% of WBC','Measured in percentage of white blood cells',1);
INSERT INTO indicator VALUES ('Lymphocytes',30,'% of WBC','Measured in percentage of white blood cells',1);
INSERT INTO indicator VALUES ('Monochytes',6,'% of WBC','Measured in percentage of white blood cells',1);
INSERT INTO indicator VALUES ('Creatinine level',100,'ng/ML','The value may be different for different animals',1);
INSERT INTO indicator VALUES ('Sodium',320,'mg/dL','Bigger animals can have a higher value',1);
INSERT INTO indicator VALUES ('Potassium',15,'mg/dL','Results can be affected by infusion of potassium-containing fluids or an infusion of glucose or insulin.',1);
INSERT INTO indicator VALUES ('Erythrocyte',40,'% of RBC','Measured in percentage of red blood cells. Normal values may vary depending on the individual laboratory and ages',1);
INSERT INTO indicator VALUES ('pH',7,'', 'Urine pH is a measure of the hydrogen ion concentration in urine',0);
INSERT INTO indicator VALUES ('Protein',50,'mg/dL', 'Trace amounts of protein can normally be found in urine',0);
INSERT INTO indicator VALUES ('Glucose',0,'mg/dL', 'Glucose is not normally found in the urine of dogs and cats',0);
INSERT INTO indicator VALUES ('Ketones',0,'mg/dL', 'Ketones are produced by lipolysis and are filtered by the glomerulus. Should be negative for Ketones',0);
INSERT INTO indicator VALUES ('Urobilinogen',0.6,'mg/dL', 'Intestinal bacteria convert conjugated bilirubin to urobilinogen',0);
INSERT INTO indicator VALUES ('Bilirubin',0.1,'mg/dL', 'Conjugated bilirubin will readily travel through the glomerulus into the filtrate. Dogs have low renal threshold for bilirubin',0);
INSERT INTO indicator VALUES ('Specific Gravity',1.030, 'mg/dL', 'Specific Gravity is a reflection of solute concentration',0);
INSERT INTO indicator VALUES ('Urine Clarity',2.5,'', 'In a scale from 1 to 5 in clarity. True reference for most animals, clear to slightly cloudy (Horses - 4, cloudy)',0);
INSERT INTO indicator VALUES ('Nitrites',110,'mg/dL', 'Abnormal values may indicate infection',0);
INSERT INTO indicator VALUES ('Benzodiazepinas',200,'mg/dL', 'Higher values indicate a possible risk of overdosage',0);
